        ...
        <ul class="nav header-navbar-rht">
            ...
            <li class="nav-item dropdown has-arrow logged-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="{{asset('images/doctors/'.Auth::user()->image)}}" width="31" alt="{{Auth::user()->name}}">
								</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="user-header">
                        <div class="avatar avatar-sm">
                            <img src="{{asset('images/doctors/'.Auth::user()->image)}}" alt="User Image" class="avatar-img rounded-circle">
                        </div>
                        <div class="user-text">
                    ...
                    <a class="dropdown-item" href="{{route('doctor.index')}}">Dashboard</a>
                    <a class="dropdown-item" href="{{route('doctor.getprofile')}}">Profile Settings</a>
